\chapter{Specifikacija programske potpore}
	...
	\section{Funkcionalni zahtjevi}
		...
		\section{Ostali zahtjevi}
			...
			\begin{packed_item} 
				\item Sustav mora podržavati istovremeni rad više korisnika u stvarnom vremenu.
				\item Unos i prikaz tekstualnog sadržaja putem korisničkog sučelja i sustava trebaju podržavati hrvatsku abecedu, uključujući dijakritičke znakove.
				\item Izvršavanje dijela programa koji pristupa bazi podataka ne smije trajati dulje od nekoliko sekundi.
				\item  Implementacija sustava treba biti izvedena kao web aplikacija koristeći objektno-orijentirane jezike.
				\item Pogrešna uporaba korisničkog sučelja ne smije utjecati na funkcionalnost i rad sustava.
				\item Korisnicima mora biti jednostavno koristiti ScootShare sučelje bez potrebe za detaljnim uputama.
				\item Nadogradnje sustava ne smiju narušavati postojeće funkcionalnosti.
				\item Sustav koristi EUR kao svoju valutu.
				\item Veza s bazom podataka mora biti sigurna, brza i otporna na vanjske pogreške.
				\item Pristup sustavu mora biti omogućen iz javne mreže putem HTTPS-a.
			\end{packed_item}
