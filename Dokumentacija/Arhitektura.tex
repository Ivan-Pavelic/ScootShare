\chapter{Arhitektura i dizajn sustava}
		...
		\section{Baza podataka}
			...
			\subsection{Opis tablica}
				...
				\begin{longtblr}[
					...
					\SetCell{LightBlue}ownerID & INT	&  	Jedinstveni identifikator iznajmljivača romobila  \\ \hline 
				\end{longtblr}
				...
				\textbf{ImageChangeRequest} Ovaj entitet pohranjuje zahtjeve korisnika za promjenu slike romobila kojeg su unajmili. Sadrži atribute: Jedinstveni identifikator najma romobila, novu sliku romobila, identifikator najma i identifikator trenutne fotografije koju želimo zamijeniti. U vezi je One-To-One sa ScooterImages te Many-To-One sa Rental entitetom.
				...
				\begin{longtblr}[
					...
					ratingTime & DATETIME & Vrijeme ocjenjivanja vožnje \\ \hline
				\end{longtblr}
		...
		\section{Dijagram razreda}
			...
			\noindent Na slikama 4.3, 4.4 i 4.5 su prikazani razredi koji pripadaju backend dijelu MVC arhitekture. Razredi prikazani na slici 4.3 nasljeduju Controller razred. Metode implementirane u tim razredima manipuliraju s DTO (Data transfer object), a oni su dohvaceni pomoću metoda implementiranih u Entitet razredima. Metode implementirane u Controller razredima vraćaju JSON datoteke s html status kodom. \\
			
			\indent Zbog lakše organizacije, razredi su podijeljeni logički po pravu pristupa metodama određenih aktora, kako bi se smanjila prenapučenost unutar dijagrama, prikazane su samo ovisnosti između razreda koji pripadaju istom dijelu dijagrama. Iz naziva i tipova atributa u razredima može se zaključiti vrsta ovisnosti među
			različitim razredima. \\
		
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{slike/ControllersDiagram.png}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{slike/DTO_dijagram.png}
			...
			\begin{figure}[H]
				\centering
				\includegraphics[width=0.8\textwidth]{slike/entiteti.png}
